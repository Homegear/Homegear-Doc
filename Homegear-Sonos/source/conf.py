...
project = u'Homegear Sonos Manual'
...
html_context = {
	...
	"conf_py_path": "/Homegear-Sonos/source/",
...
latex_documents = [
    (master_doc, 'Homegear.tex', u'Homegear Sonos Manual',
...
man_pages = [
    (master_doc, 'homegear', u'Homegear Sonos Manual',
     [author], 1)
]
