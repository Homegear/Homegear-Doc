...
project = u'Homegear Intertechno Manual'
...
html_context = {
	...
	"conf_py_path": "/Homegear-Intertechno/source/",
...
latex_documents = [
    (master_doc, 'Homegear.tex', u'Homegear Intertechno Manual',
...
man_pages = [
    (master_doc, 'homegear', u'Homegear Intertechno Manual',
     [author], 1)
]
