...
project = u'Homegear Nanoleaf Manual'
...
html_context = {
	...
	"conf_py_path": "/Homegear-Nanoleaf/source/",
...
latex_documents = [
    (master_doc, 'Homegear.tex', u'Homegear Nanoleaf Manual',
...
man_pages = [
    (master_doc, 'homegear', u'Homegear Nanoleaf Manual',
     [author], 1)
]
