...
project = u'Homegear M-Bus Manual'
copyright = u'2018, Sathya Laufer'
...
html_context = {
	...
	"conf_py_path": "/Homegear-M-Bus/source/",
...
latex_documents = [
    (master_doc, 'Homegear.tex', u'Homegear M-Bus Manual',
...
man_pages = [
    (master_doc, 'homegear', u'Homegear M-Bus Manual',
     [author], 1)
]
