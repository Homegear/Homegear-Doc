...
project = u'Homegear EnOcean Manual'
...
html_context = {
	...
	"conf_py_path": "/Homegear-EnOcean/source/",
...
latex_documents = [
    (master_doc, 'Homegear.tex', u'Homegear EnOcean Manual',
...
man_pages = [
    (master_doc, 'homegear', u'Homegear EnOcean Manual',
     [author], 1)
]
