...
project = u'Homegear Z-Wave Manual'
...
html_context = {
	...
	"conf_py_path": "/Homegear-Z-Wave/source/",
...
latex_documents = [
    (master_doc, 'Homegear.tex', u'Homegear Z-Wave Manual',
...
man_pages = [
    (master_doc, 'homegear', u'Homegear Z-Wave Manual',
     [author], 1)
]
