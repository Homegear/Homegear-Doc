...
project = u'Homegear Zigbee Manual'
copyright = u'2016-2020, Homegear GmbH'
...
html_context = {
	...
	"conf_py_path": "/Homegear-Zigbee/source/",
...
latex_documents = [
    (master_doc, 'Homegear.tex', u'Homegear Zigbee Manual',
...
man_pages = [
    (master_doc, 'homegear', u'Homegear Zigbee Manual',
     [author], 1)
]
