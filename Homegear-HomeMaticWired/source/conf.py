...
project = u'Homegear HomeMatic Wired Manual'
copyright = u'2016-2018, Homegear GmbH'
...
html_context = {
	...
	"conf_py_path": "/Homegear-HomeMaticWired/source/",
...
latex_documents = [
    (master_doc, 'Homegear.tex', u'Homegear HomeMatic Wired Manual',
...
man_pages = [
    (master_doc, 'homegear', u'Homegear HomeMatic Wired Manual',
     [author], 1)
]
