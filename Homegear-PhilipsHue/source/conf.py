...
project = u'Homegear Philips hue Manual'
copyright = u'2019, Sven Klomp'
author = u'Sven Klomp'
...
html_context = {
	...
	"conf_py_path": "/Homegear-PhilipsHue/source/",
...
latex_documents = [
    (master_doc, 'Homegear.tex', u'Homegear Philips hue Manual',
     u'Sven Klomp', 'manual'),
]
...
man_pages = [
    (master_doc, 'homegear', u'Homegear Philips hue Manual',
     [author], 1)
]
